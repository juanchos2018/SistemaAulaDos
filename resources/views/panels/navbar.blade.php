        ...
        <ul class="nav navbar-nav">
            <li class="nav-item">
                <a class="navbar-brand" href="{{url('/')}}">
                    ...
                    <h2 class="brand-text mb-0">Sistema</h2>
                </a>
            </li>
        </ul>
    </div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                        <li class="dropdown-menu-header">
                            <div class="dropdown-header d-flex">
                                ...
                                <div class="badge badge-pill badge-light-primary">3 Nuevas</div>
                            </div>
                        </li>
                        <li class="scrollable-container media-list"><a class="d-flex" href="javascript:void(0)">
                                <div class="media d-flex align-items-start">
                                    <div class="media-left">
                                        <div class="avatar"><img
                                                src="{{asset('images/portrait/small/avatar-s-15.jpg')}}" alt="avatar"
                                                width="32" height="32"></div>
                                    </div>
                                    <div class="media-body">
                                        <p class="media-heading"><span class="font-weight-bolder">Notificacion 1
                                                🎉</span>Tarea!</p><small class="notification-text"> Descripcion noti.</small>
                                    </div>
                                </div>
                                ...
                                <div class="media d-flex align-items-start">
                                    ...
                                    <div class="media-body">
                                        <p class="media-heading"><span class="font-weight-bolder">Notificacion 2</span>&nbsp;Tarea</p><small class="notification-text"> You
                                        Descripcion noti</small>
                                    </div>
                                </div>
                            </a><a class="d-flex" href="javascript:void(0)">
                                <div class="media d-flex align-items-start">
                                    ...
                                    <div class="media-body">
                                        <p class="media-heading"><span class="font-weight-bolder">Notificacion 3
                                                👋</span>&nbsp;Tarea</p><small class="notification-text">  Descripcion noti</small>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li class="dropdown-menu-footer"><a class="btn btn-primary btn-block"
                                href="javascript:void(0)">Todas las notificationes</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown dropdown-user">
                    <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
                        ...
                        <div class="user-nav d-sm-flex d-none">
                            <span class="user-name font-weight-bolder"> {{Session::get('USU_NM')}}</span>
                            <span class="user-status">{{Session::get('USU_ROL_NAME')}}</span>
                        </div>
                        <span class="avatar">
