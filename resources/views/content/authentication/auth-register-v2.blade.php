...
<div class="auth-wrapper auth-v2">
  <div class="auth-inner row m-0">
    ...
    <a class="brand-logo" href="javascript:void(0);">
      ...
      <h2 class="brand-text text-primary ml-1">Sistema</h2>
    </a>
    <!-- /Brand logo-->
    <!-- Left Text-->
    ...
    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
      <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        <h2 class="card-title font-weight-bold mb-1">Sistema de Colegio 🚀</h2>
        <p class="card-text mb-2">Make your app management easy and fun!</p>
        <form class="auth-register-form mt-2" action="/" method="GET">
          <div class="form-group">
            <label class="form-label" for="register-username">Nombres</label>
          ...
          <a href="{{url('auth/login-v2')}}">
            <i data-feather="chevron-left"></i> Atrás para iniciar sesión
          </a>
        </p>
        </form>
